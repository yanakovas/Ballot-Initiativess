  ...
  <div className="modal-dialog modal-dialog-centered modal-xl" style={{width:'800px'}} >
    <div className="modal-content">
      <div className="modal-header sm">
        <h1 className="modal-title fs-6" id="exampleModalLabel">Изменение инициативы:</h1>
  ...
  <div className="mb-3">
    ...
    <input type="date" className="form-control" required id="exampleInputPassword1"/>
      ...
      <div className="modal-footer">
        <button type="button" className="btn btn-primary btn-sm">Изменить</button>
      </div>
    </div>
  </div>
</div>
